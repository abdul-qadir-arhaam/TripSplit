...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-brand-600 hover:bg-brand-500 text-white shadow-glow-brand focus:ring-brand-500',
    secondary: 'bg-slate-800 hover:bg-slate-700 text-slate-100 border border-slate-700 focus:ring-slate-600',
    outline: 'border border-slate-700 hover:border-slate-500 text-slate-300 hover:text-white hover:bg-slate-800/40 focus:ring-slate-600',
